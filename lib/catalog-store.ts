...
export const AVAILABLE_PRODUCT_IMAGES = [
  { label: "T-shirt Noir (Typo 3×3)", value: "/images/products/tshirt-noir.jpg" },
  { label: "T-shirt Blanc (Typo 3×3)", value: "/images/products/tshirt-blanc.jpg" },
  { label: "T-shirt Scène Solo 166 (Lime)", value: "/images/products/tshirt-solo166.jpg" },
  { label: "T-shirt Éco Danser Rassembler", value: "/images/products/tshirt-eco.jpg" },
  { label: "Casquette YON Studio", value: "/images/products/casquette-yon.jpg" },
  { label: "Casquette Vintage Washed", value: "/images/products/casquette-vintage.jpg" },
  { label: "Casquette Minimaliste 166", value: "/images/products/casquette-166.jpg" },
];

export const AVAILABLE_GALLERY_IMAGES = [
  { label: "Solo Vert Lime (Jo Grabowski)", value: "/images/ahmed-soura-green.jpg" },
  { label: "Performance & Énergie Scénique", value: "/images/ahmed-soura-performance.jpg" },
  { label: "Flexion Dorsale Sculpturale", value: "/images/ahmed-soura-arched.jpg" },
  { label: "Portrait Studio Capuche", value: "/images/ahmed-soura-hooded.jpg" },
  { label: "Emblème Officiel Yongonlon", value: "/images/yongonlon-logo.jpg" },
];

export function loadBoutiqueProducts(): ProductItem[] {
  if (typeof window === "undefined") return DEFAULT_PRODUCTS;
  try {
    const saved = localStorage.getItem("as_boutique_products");
    if (saved) {
...
export function saveBoutiqueProducts(products: ProductItem[]) {
...
export function loadGalleryItems(): GalleryItem[] {
  ...
  try {
    const saved = localStorage.getItem("as_gallery_items");
    if (saved) {
      const parsed = JSON.parse(saved);
      if (Array.isArray(parsed) && parsed.length > 0) return parsed;
    }
